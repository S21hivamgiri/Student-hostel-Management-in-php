...
<?php 
    ...
    $findStmt = $document->find(["role"=>"emergency"]);
...
foreach($findStmt as $as)
{
    ...
    <form action='emer-update.php?id=". $as['id'] ."' method='POST'>
        ...
        <td> <input type='text' class='form-control' name='emergency-des' value='". $as['desg'] ."'required></td>
        <td> <input type='text' class='form-control' name='emergency-email' value='". $as['email'] ."'required></td>
        <td> <input type='text' class='form-control' name='emergency-num' value='". $as['contact'] ."'required></td>
