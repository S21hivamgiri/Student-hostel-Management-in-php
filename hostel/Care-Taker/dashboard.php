            ...
            <ul class="left_section">
                ...
                <div class="dropdown student_section_dropdown">
                    <ul class="dropdown_list">
                        ...
                        <li class="list_item acc-details" id="30">Room accessories Details</li>
                ...
                <div class="dropdown spo_med_contact_dropdown">
                    <ul class="dropdown_list">
                        ...
                        <li class="list_item insert-med" id="20"> Insert Medicine</li>
                        <li class="list_item update-med" id="20"> Update Medicine</li>
                         <li class="list_item view-sports" id="20"> Views Medicine</li>
                        <li class="list_item insert-sports" id="20"> Insert Sports</li>
                        <li class="list_item update-sports" id="20"> Update Sports</li>
                    </ul>
                </div>
                ...
                <div class="dropdown fees_feedback_dropdown">
                    <ul class="dropdown_list">
                          <li class="list_item fee-details" id="26">Insert Fees  Details</li>
                        <li class="list_item fee-unpaid" id="26">Fees  Not Paid List</li>
                        <li class="list_item view-fee" id="26">View Fees Paid</li> 
                        <li class="list_item reset-fees" id="26">Reset Fees for Next Semester</li> 
