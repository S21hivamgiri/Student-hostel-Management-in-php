...
<?php 
    ...
    $findStmt = $document->find(["role"=>"medicine"]);

    echo '     
    <table><tr>
    <td class="section_sub_title">Name of Medicine</td>
    <td class="section_sub_title">Qunatity</td>
    <td class="section_sub_title">Remedy For</td>
...
foreach($findStmt as $as)
{
    ...
    <form action='medi-update.php?id=". $as['id'] ."' method='POST'>
        ...
        <td> <input type='text' class='form-control' name='emergency-email' value='". $as['for'] ."'required></td>
