        ...
        <form action="" method="post">
            <?php 
                if(isset($_POST['update-emergency']))
                {
                    ...
                    $i= $document->count(["role"=>"medicine"]);
                    $val=$i+1;
                    ...
                    The medicine ".$_POST['emergency-name']." , X ".$_POST['emergency-des']. "has been successfully uploaded</b>
                </div>";
                   
                }
            ?>
            <div class="img-ctn-h1">
                <h1>Insert Medicine info</h1>
            </div>
            <br>
            <div class="form-group">
                <label for="emergency-name">Enter Medicine Name</label>
                <input type="text" class="form-control" name="emergency-name" placeholder="Enter Name" required>
            </div>
            <div class="form-group">
                <label for="emergency-name">Enter Qunatity</label>
                <input type="number" class="form-control" name="emergency-des" placeholder="Enter Quantity" required>
            </div>
            <div class="form-group">
                <label for="emergency-name">Medicine is Remedy for:</label>
                <input type="text" class="form-control" name="emergency-num" placeholder="Enter Remedy for" required>
            </div>
