...
<body>
    <div class="cp-div pwd-wide">
        <form action="" method="post">
            ...
            $findQuery = $document->findOne(['roll_no' => $roll]);
           
            if($findQuery['otp']===$code)  {
                if(isset($_POST['updatePwd'])){
                    if($_POST['newPassword'] !== $_POST['confirmPassword']){
                        ...
                        $updateQuery = $document->updateOne(['roll_no' => $roll], 
                        ['$set' => ['password' => ($new_Password),'otp'=>'']]);
                        session_destroy();
                        echo '<script>
