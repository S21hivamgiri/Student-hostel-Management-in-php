...
if (($_SESSION['i_year'] %100) >= 11 && ($_SESSION['i_year']%100) <= 13)
   $abbreviation = 'th';
else
   $abbreviation = $ends[$_SESSION['i_year'] % 10];
...
EN-GB'><?php echo $_SESSION['i_year'].$abbreviation.' ';?></span><span lang=EN-GB style='font-size:48.0pt;mso-bidi-font-size:
11.0pt;line-height:106%;font-family:"Denka",sans-serif;color:#C5E0B4;
mso-ansi-language:EN-GB'> INDEPENDENCE DAY</span><span lang=EN-GB
