        ...
        <div>
            ...
            <?php 
                ...
                <td class="section_sub_title make-entry-table-title-small">Id</td>
                    ...
                    <td class="section_sub_title make-entry-table-title-small">Update Entry</td>
                </tr>';
                ...
                if($allEntries){
                    foreach ($allEntries as $ae) {
                        ...
                        if(strtotime($ae['in_date'])<=strtotime(date("Y-m-d")))
                        {
                        if(($ae['out_time'] == '' || $ae['out_date'] == '') && $ae['role'] == $room_select && $ae['in_time']!=0)
                        {
                            echo "
                                <tr class='list-item'>
                                    <form method='POST' action='update-vis-entry.php?uid=".$ae['id']."&role=".$room_select."'>  
