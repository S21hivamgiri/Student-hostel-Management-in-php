...
<div class=WordSection1>
            ...
            <div class="img-ctn-h1">
                <h1>STUDENT LEAVING THE HOSTELS</h1>
            </div>
...
if($result['journey']==-1 && $result['grant']==1)

echo"
<form action='depart-action.php?l_id=".$result['l_id']."' method='post' >
...
<center>
     <input type='submit' name='depart' value='Student Departing' class='btn btn-primary img-ctn-btn'>
