    ...
    <div class="search-bar">
        ...
        <form action="" method="post">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                    <input type="text" name="rollno" placeholder="Enter Roll Mumber">
                </div>
            ...
            <?php 
                ...
                if(isset($_POST['search-std']))
                {
                    ...
                    if($regno)
                    {
                        ...
                        {
                            if($as['roll_no'] == $regno && $as['role'] == 'Student'&& $as['mr'] == 'Student'&& $as['role'] == 'hr')
                            {
                                echo "
                    ...
                    else if($roomno)
                    {
                        foreach($allStudents as $as)
                        {
                            if($as['room_no'] == $roomno && $as['role'] == 'Student'&& $as['role'] == 'Student'&& $as['mr'] == 'Student'&& $as['role'] == 'hr')
                            {
                                echo "
                                    <tr class='pending-list-item'>
                                        <td>". $as['name']."</td>
                    ...
                    else if($floorno)
                    {
                        foreach($allStudents as $as)
                        {
                            if($as['floorno'] == $floorno && $as['role'] == 'Student'&& $as['role'] == 'Student'&& $as['mr'] == 'Student'&& $as['role'] == 'hr')
                            {
                                echo "
                                    <tr class='pending-list-item'>
                                        <td>". $as['name']."</td>
                    ...
                    else if($hostel)
                    {
                        foreach($allStudents as $as)
                        {
                            if($as['hostelno'] == $hostel && $as['role'] == 'Student'&& $as['role'] == 'Student'&& $as['mr'] == 'Student'&& $as['role'] == 'hr')
                            {
                                echo "
                                    <tr class='pending-list-item'>
                                        <td>". $as['name']."</td>
