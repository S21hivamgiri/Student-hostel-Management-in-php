...
if($_SESSION['field']=="Cheif Warden")$code="C";
else if($_SESSION['field']=="Warden")$code="W";

else if($_SESSION['field']=="Assistant Warden")$code="AW";

else if($_SESSION['field']=="Care Taker")$code="CT";
 $temp=$code.$year."00";
$role=$_SESSION['field'];
    $year=date("Y");
    $ar=date("y");
    ...
    $semyear= ($year-1).'-'.($ar);
    $count = $document->count(['role'=>$_SESSION['field']]);
    if($count==0)
    {
        ...
        if ($_POST['verify'] == '1') 
               ...
               $result = $document->findOne(['p_email' => $_POST['email']]);
                ...
                // if everything is ok, try to upload file
                    ...
                    $_FILES["fileToUpload"]["name"]=$roll.".". $file_extension;
                    $target_file = $target_dir . basename($_FILES["fileToUpload"]["name"]);
                    ...
                    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                        ...
                        $actual_link = "http://$_SERVER[HTTP_HOST]/hostel/"."activatwemail.php?id=".$roll."&code=".$code;
...
<img  alt='footer' src='cid:my-footer' style='width: 100%;  height: auto;'>
           ...
           header("location:newpassw.php");

                    } else {
                        echo "  <div class='alert alert-danger index-alert-upd' role='alert'>
                            Sorry, there was an error uploading your file. Cannot save Update Your Information 
                        </div>";
                    }
                                    ...
                                    else echo "You must verify  declaration!!!";   
...
<head>
   ...
   <link rel="stylesheet" href="./assets/css/style.css">
	...
	<div class="centerstage row">
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 container infostage">
            ...
            <div class="form-group">
                            ...
                            <div class="form-group">
                    <label>Gender</label>
                    <input type="radio" name="gender" value="male" class="login-fields-r spec-2" required><span class="radio">Male</span> 
                    <input type="radio" name="gender" value="female" class="login-fields-r spec-2" required><span class="radio">Female</span> 
                    </div>
...
<?php
if($_SESSION['field']=="W"||$_SESSION['field']=="AW"||$_SESSION['field']=="CT")
{
...
<select name="country" style=" border-radius:4px;" class="floor-select-st shift-up">                   
    ...
    <option value='Zimbabwe'>Zimbabwe</option>    
            ...
            <div class="section_title spread">
                         ...
                         <div class="form-group">
                   Upload a Photograph:
                <input type="file" name="fileToUpload" id="fileToUpload" required class="spec-1">
                <br><br>
             </div>

            <div class="form-group">
            
            <input type="checkbox" class="form-control spec-2" name="verify" id="checkpost" value="1" required>
            <label>I hereby declare that above Information are best of my knowledge and Wrong Information can results to inconsistency in the hostel management</label>  
            </div>
            <div class="center-align">
                <input type="submit" name="wardinfo" value="Submit Info" class="btn btn-primary btn-btn">
            </div>
