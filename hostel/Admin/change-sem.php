            ...
            <div class="container initiate-file">
                <div class="feedback">
                   <form action="" method="POST">
                    ...
                    <div class="form-group">
                    <label for="search">Enter Year of Study</label><br>
                        ...
                        <input type="submit" name="course" value="Submit Info" class="btn btn-primary img-ctn-btn">
                       </div>
                       <?php
                       if(isset($_POST['course']))
                       {
                            ...
                            header("location:update-sem.php");
                       }
                       ?>
                </form>
                <p>OR</p>
                <form action="" method="POST">
                    <?php
                     ...
                     {    $_SESSION['roll']=$_POST['rollno'];
                            header("location:update-semester.php");}
                    ?> 
                    <div class="section_title spread">
                            <h1>Update With Roll No.</h1>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                            <input type="submit" name="roll" value="Submit Roll" class="btn btn-primary img-ctn-btn">
                    </div>
                </form>
                </div></div></div></div>